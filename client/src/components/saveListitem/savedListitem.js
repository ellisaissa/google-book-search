        ...
        <div>
            <div className="card">
                ...
                <div className="card-body">
                    ...
                    <p style={{fontStyle: "bold"}}>Author(s): {authors}</p>
                    <a href={link} target="_blank" rel="noopener noreferrer" className="btn" style={{marginRight: "6px", backgroundColor: "rgb(51, 43, 94)", color: "white"}}>Look at Book</a>
